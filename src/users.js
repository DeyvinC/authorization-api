...
exports.createUser = (req, res) => {
    ...
    .then(doc => {
        ...
        // TODO: create a JWT and send back the token  // bottom line does this
        
        const token = jwt.sign(user,'doNotShareYourSecret' ) // protect your secret
        res.status(201).send({
            success: true,
...
exports.loginUser = (req,res) => {
    ...
    const db = connectDb();
    db.collection('users').where('email', '==', req.body.email.toLowerCase())
...
exports.getUsers = (req,res) => { 
    // first make sure that the user sent authoricatio token
    ...
    // TODO protect this route JWT // bottom line of code 
